package com.rose.permission.aspect;
...
import com.rose.permission.interfaces.IPermissionCallback;
import com.rose.permission.utils.ApplicationUtil;
import com.rose.permission.utils.PermissionUtil;
...
public class PermissionAspect {
    ...
    private final String pointcutExpression2
            = "execution(@com.rose.permission.annotation.PermissionNeed * *(..)) && @annotation(permissionNeed)";
